...
namespace RTCube.Extensions
{
	...
	public class StateTracker<TStateData>
	{
		...
		public bool IsActive => activeTokens.Any();
		...
		public IEnumerable<IStateToken<TStateData>> ActiveTokens => activeTokens;
