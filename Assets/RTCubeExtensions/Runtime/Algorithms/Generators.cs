...
namespace RTCube.Extensions.Algorithms
{
	...
	public interface IGenerator
	{
		...
		/// </summary>
		/// <remarks>
		/// It is always (in theory) valid to query this property.
	...
	/// <remarks>
	/// <para>
	/// Instances of <see cref="IGenerator{TResult}"/> are usually obtained from the static methods in the
	/// <see cref="Generator"/>. See [Generators](../content/Generators.md) for more information.
	/// </para>
	/// <para>
	/// To correctly implement this interface:
	/// </para>
	/// <list type="bullet">
	/// <item>A call to <see cref="Current"/> immediately after constructing the class 
	/// must give the first element of the generator. This is in contrast to 
	/// IEnumerator, where a call to <see cref="IGenerator.MoveNext"/> must be made first.</item>
	/// <item>Calls to <see cref="Current"/> must always give a valid element, no matter
	/// how many times <see cref="IGenerator.MoveNext"/> has been called. Generators never end. </item>
	/// <item>Calls to <see cref="Current"/> must always give the same value until the next 
	/// call to <see cref="IGenerator.MoveNext"/> is made.</item>
	/// <item><see cref="IGenerator.MoveNext"/> must make all computations to generate the next element. In general, a private 
	/// variable holds the current value, is calculated in this method, and returned by Current. </item>
	/// <item>Generators that are built from other generators must <see cref="IGenerator.CloneAndRestart"/> the generators and store 
	/// the clones. This ensures calls to <see cref="IGenerator.MoveNext"/> in this generator won't affect elements generated by 
	...
	/// produce an equivalent generator in <see cref="IGenerator.CloneAndRestart"/>. Generally, generators are equivalent when 
	...
	/// <see cref="IGenerator.CloneAndRestart"/> generators stored internally when creating a new instance of the generator, since
	...
	/// </summary>
	/// <remarks>
	/// A generator is a class that generates data on demand. In this implementation, 
	...
	/// cloned, so no derived generator will call the
	/// <see cref="Next{TSource}(RTCube.Extensions.Algorithms.IGenerator{TSource})"/> or
	/// <see cref="IGenerator.MoveNext"/> methods of an existing generator.
	...
	/// are always in a "valid" state, so calls to <see cref="IGenerator{TResult}.Current"/> will always return a valid
	/// result, there is no "before first" and "after last" states. 
	/// 
	...
	/// that implements the <see cref="IGenerator{TResult}"/> interface.
	/// </remarks>
	[Version(1, 0, 0)]
	public static class Generator
	{
		...
		/// <param name="source">The generator function that will be 
		/// called to generate new elements.</param>
		/// <exception cref="System.ArgumentNullException">generator</exception>
		public static IGenerator<TResult> FromFunc<TResult>(Func<TResult> source)
		{
			if (source == null) throw ArgumentNullException("generator");

			return new FuncGenerator<TResult>(source);
		}
		...
		/// the result generator will generate <c>x, f(x), f(f(x)), f(f(f(x))), ...</c></remarks>
		...
		/// takes two parameters; the second parameter is supplied by a generator.
		/// </summary>
		public static IGenerator<TSource> Iterate<TSource, TSource2>(
			TSource initialElement,
			IGenerator<TSource2> source, 
			Func<TSource, TSource2, TSource> iterator)
		{
			if (iterator == null) throw ArgumentNullException("iterator");

			return new IterateGenerator1<TSource, TSource2>(initialElement, source, iterator);
		}
		...
		// TODO: Use the same group as LINQ
		/// <summary>
		...
		/// <seealso cref="OpenSawTooth(int)"/>
		/// <remarks>
		/// This generator is designed to be used with <see cref="Select{TSource,TResult}"/> to generate outputs of
		/// periodic functions.
		/// </remarks>
		...
		{
			var xGenerator = UniformRandomFloat(RTCRandom.GlobalRandom.Next());
			var yGenerator = UniformRandomFloat(RTCRandom.GlobalRandom.Next());
		...
		{
			if (source1 == null) throw ArgumentNullException("generator1");
			if (source2 == null) throw ArgumentNullException("generator2");
			if (resultSelector == null) throw ArgumentNullException("resultSelector");

			return new CombineGenerator<T1,T2,TResult>(source1, source2, resultSelector);
		}
		...
		/// <param name="source1">The first generator.</param>
		/// <param name="source2">The second generator.</param>
		/// <param name="source3">The third generator.</param>
		/// <param name="resultSelector">The result selector function.</param>
		/// <returns>A new generator</returns>
		/// <exception cref="System.ArgumentNullException"><c>generator1</c> is <b>null</b>.</exception>
		/// <exception cref="System.ArgumentNullException"><c>generator2</c> is <b>null</b>.</exception>
		...
		public static IGenerator<TResult> Combine<T1, T2, T3, TResult>(
			IGenerator<T1> source1,
			IGenerator<T2> source2,
			IGenerator<T3> source3,
			Func<T1, T2, T3, TResult> resultSelector)
		{
			if (source1 == null) throw ArgumentNullException("generator1");
			if (source2 == null) throw ArgumentNullException("generator2");
			if (source3 == null) throw ArgumentNullException("generator3");
			if (resultSelector == null) throw ArgumentNullException("resultSelector");
		...
		/// <param name="source2">The second generator.</param>
		/// <param name="source3">The third generator.</param>
		/// <param name="source4">The fourth generator.</param>
		/// <param name="resultSelector">The result selector function.</param>
		/// <returns>A new generator</returns>
		/// <exception cref="System.ArgumentNullException"><c>generator1</c> is <b>null</b>.</exception>
		/// <exception cref="System.ArgumentNullException"><c>generator2</c> is <b>null</b>.</exception>
		...
		public static IGenerator<TResult> Combine<T1, T2, T3, T4, TResult>(
			...
			IGenerator<T2> source2,
			IGenerator<T3> source3,
			IGenerator<T4> source4,
			Func<T1, T2, T3, T4, TResult> resultSelector)
		{
			if (source1 == null) throw ArgumentNullException("generator1");
			if (source2 == null) throw ArgumentNullException("generator2");
			if (source3 == null) throw ArgumentNullException("generator3");
			if (source4 == null) throw ArgumentNullException("generator4");
			if (resultSelector == null) throw ArgumentNullException("resultSelector");
		...
		/// <typeparam name="TResult">The type of elements this generator will generate.</typeparam>
		/// <param name="sources">The generators.</param>
		...
		public static IGenerator<TResult> Combine<TSource, TResult>(
			IEnumerable<IGenerator<TSource>> sources,
			Func<IList<TSource>, TResult> resultSelector)
		{
			if (sources == null) throw ArgumentNullException("generators");
			// ReSharper disable once PossibleMultipleEnumeration
			if (sources.ContainsNullElements()) throw ContainsNullElementsException("generators");
			
			// ReSharper disable once PossibleMultipleEnumeration
			return new CombineGenerator<TSource,TResult>(sources, resultSelector);
		}
		...
		/// <param name="sourceGenerators">The source generators.</param>
		/// <param name="indexGenerator">The index generator.</param>
		/// <returns>A new generator.</returns>
		...
		/// </example>
		public static IGenerator<TSource> Choose<TSource>(IList<IGenerator<TSource>> sourceGenerators, 
			IGenerator<int> indexGenerator)
		{
			if (sourceGenerators == null) throw ArgumentNullException("generators");
			if (!sourceGenerators.Any()) throw CollectionEmptyException("generators");
			if (indexGenerator == null) throw ArgumentNullException("indexGenerator");

			return new ChooseGenerator<TSource>(sourceGenerators, indexGenerator);
		}
		...
		*/
		...
		/// <exception cref="System.ArgumentException"><paramref name="source"/>is empty.</exception>
		public static IGenerator<TSource> ChooseUniformRandom<TSource>(IList<TSource> source)
		{
			if (source == null) throw ArgumentNullException("list");
			if (!source.Any()) throw CollectionEmptyException("list");

			return Choose(source, UniformRandomInt(source.Count));
		}
		...
		public static IGenerator<TSource> ChooseUniformRandom<TSource>(IList<TSource> source, int seed)
		{
			...
			return Choose(source, UniformRandomInt(source.Count, seed));
		}
		...
		/// </summary>
		/// <typeparam name="TSource">The type of elements to generate.</typeparam>
		/// <param name="source">The list of generators to choose from.</param>
		/// <returns>A new generator.</returns>
		...
		public static IGenerator<TSource> ChooseUniformRandom<TSource>(IList<IGenerator<TSource>> source)
		{
			if (source == null) throw ArgumentNullException("list");
			if (!source.Any()) throw CollectionEmptyException("list");
			if (source.ContainsNullElements()) throw ContainsNullElementsException("list");
		...
		public static IGenerator<TSource> ChooseUniformRandom<TSource>(params IGenerator<TSource>[] source)
		{
			...
			return Choose(source, UniformRandomInt(source.Length));
		}
		...
		public static IGenerator<TSource> ChooseUniformRandom<TSource>(IList<IGenerator<TSource>> source, int seed)
		{
			if (source == null) throw ArgumentNullException("list");
			if (!source.Any()) throw CollectionEmptyException("list");
			if (ContainsNullElements(source)) throw ContainsNullElementsException("list");
		...
		/// <summary>
		/// Makes a generator that applies an <see cref="Action{T}"/> on the elements it generates.
		/// </summary>
		...
		public static IGenerator<TSource> Apply<TSource>(
			this IGenerator<TSource> source, Action<TSource> action)
		{
			if (source == null) throw ArgumentNullException("generator");
		...
		/// <param name="sources">The other generators.</param>
		/// <returns>A new generator.</returns>
		/// <exception cref="System.ArgumentNullException"><c>generator</c> is $(null)</exception>
		...
		/// </summary>
		/// <typeparam name="TSource">The type of elements to generate.</typeparam>
		/// <param name="sources">The source generators.</param>
		/// <returns>A new generator.</returns>
		...
		{
			if (sources == null) throw ArgumentNullException("generators");
			if (!sources.Any()) throw CollectionEmptyException("generators");
			if (sources.ContainsNullElements()) throw ContainsNullElementsException("generators");
			
			int generatorCount = sources.Count;
			var choiceGenerator = Count(generatorCount);

			return Choose(sources, choiceGenerator);
		}
			...
			int count)
		{
			...
			var clonedGenerator = source.CloneAndRestart();
		...
		// TODO: This is exactly the same as Cast. Depricate one of them. 
		/// <summary>
		...
		/// <typeparam name="TResult">The type of elements to generate.</typeparam>
		/// <param name="source">The source generator.</param>
		/// <param name="aggregator">The aggregator function. The two parameters, in order, is the aggregation so far,
		/// the next value of <paramref name="source"/>. The result is the new aggregation. </param>
			...
			TResult initialValue)
		{
			...
			return new AggregateGenerator<TSource, TResult>(source, aggregator, initialValue);
		}
			...
			TSource initialValue)
		{
			...
			return new AggregateGenerator<TSource, TSource>(source, aggregator, initialValue);
		}
			...
			Func<TSource, TSource, TSource> aggregator)
		{
			...
			return new AggregateGenerator<TSource>(source, aggregator);
		}
		...
		/// </summary>
		/// <typeparam name="TSource">The type of the source generator.</typeparam>
		/// <param name="initialSource">The source.</param>
		/// <param name="predicate">The predicate.</param>
		/// <param name="newSource">The new generator.</param>
		/// <returns>A new generator</returns>
		/// <exception cref="System.ArgumentNullException"><c>source</c> is <b>null</b></exception>
		...
		public static IGenerator<TSource> SwitchWhen<TSource>(
			this IGenerator<TSource> initialSource,
			Func<TSource, bool> predicate,
			IGenerator<TSource> newSource)
		{
			if (initialSource == null) throw ArgumentNullException("source");
			if (predicate == null) throw ArgumentNullException("predicate");
			if (newSource == initialSource) throw ArgumentNullException("newGenerator");

			var sourceCopy = initialSource.CloneAndRestart(); //otherwise we affect the results of source after this method is called
			var first = sourceCopy.NextWhile(x => !predicate(x)).Concat(sourceCopy.Next(1));

			return newSource.Pad(first);
		}
		...
		/// </summary>
		/// <typeparam name="TSource">The type of the source generator.</typeparam>
		/// <param name="initialSource">The source generator that will be used before the switch.</param>
		/// <param name="steps">The number of steps before switching.</param>
		/// <param name="newSource">The new generator that will be used after the switch.</param>
		/// <returns>A new generator.</returns>
		/// <exception cref="System.ArgumentNullException"><c>source</c> is <b>null</b></exception>
		/// <exception cref="System.ArgumentNullException"><c>newGenerator</c> is <b>null</b></exception>
			...
			IGenerator<TSource> newSource)
		{
			...
			return Combine(selection, initialSource, newSource, (choice, x, y) => choice ? x : y);
		}
		...
		private sealed class FrequencyIntGenerator : AbstractGenerator<int>
		{
			/*
				...
				The algorithm for generating integers <c>0..n-1</c> is based on n buckets. First, we randomly 
				select which bucket to use. Each bucket, bucket[i], is associated with two integers, index0[i]
				and index1[i], and holds a discriminator value. For a given bucket, if another random value
				falls below the discriminator, the algorithm produces index0[i], otherwise index1[i].

				The discriminators and index arrays are chosen so that the probability of generating
			...
			*/
				...
				IGenerator<float> randomGenerator)
			{
				...
				if (frequencies.Length == 1)
				{
					if (frequencies[0] <= 0)
					{
						throw new ArgumentException("Sum of frequencies cannot be 0", nameof(relativeFrequencies));
					}
				...
				{
					throw new ArgumentException("Frequencies must be non-negative", nameof(relativeFrequencies));
				}
			...
			public override int Current => currentElement;
		...
		private sealed class ConstantGenerator<TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => item;
		...
		private sealed class SelectGenerator<TSource, TResult> : AbstractGenerator<TResult>
		{
			...
			public override TResult Current => func(generator.Current);
		...
		private sealed class SelectManyGenerator<TSource, TResult> : AbstractGenerator<TResult>
		{
			...
			public override TResult Current => currentIterator.Current;
		...
		private sealed class WhereGenerator<TSource> : AbstractGenerator<TSource>
		{
				...
				int maxIterations)
			{
				...
				{
					throw new ArgumentOutOfRangeException(nameof(maxIterations), "Argument must be positive");
				}
			...
			public override void MoveNext()
			{
				...
				while (!predicate.Current)
				{
					...
					{
						throw new TimeoutException($"Could not generate an element in {maxIterations} iterations");
					}
			...
			public override TSource Current => generator.Current;
		...
		private sealed class RepeatGenerator<TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => iterator.Current;
		...
		private sealed class WindowGenerator<TSource> : AbstractGenerator<TSource[]>
		{
			...
			public override TSource[] Current => queue.ToArray();
		...
		private sealed class ChooseGenerator<TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => generators[choice.Current].Current;
		...
		private sealed class CombineGenerator<T1, T2, TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => func(generator1.Current, generator2.Current);
		...
		private sealed class CombineGenerator<T1, T2, T3, TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => func(generator1.Current, generator2.Current, generator3.Current);
		...
		private sealed class UniformRandomFloatGenerator : AbstractGenerator<float>
		{
			...
			public override float Current => current;
		...
		private sealed class IterateNGenerator<TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => queue.Peek();
		...
		private sealed class GroupGenerator<TSource> : AbstractGenerator<IList<TSource>>
		{
			...
			public override IList<TSource> Current => currentGroup;
		...
		private sealed class PadGenerator<TSource> : AbstractGenerator<TSource>
		{
			...
			public override TSource Current => donePadding ? generator.Current : enumerator.Current;
		...
		private class CastGenerator<TResult> : AbstractGenerator<TResult>
		{
			...
			public override TResult Current => (TResult)generator.Current;
		...
		private sealed class PoissonGenerator : AbstractGenerator<bool>
		{
			private readonly int minRadius;
			public readonly int maxRadius;
			private readonly IGenerator<int> radiusGenerator;
			
			private bool current;
			private int currentIndex;

			public override bool Current => current;
