...
namespace RTCube.Extensions.Internal.KDTree
{
	/// <summary>
	...
	public class KDNode<T>
	{
		...
		/// </summary>
		protected internal Vector2 tMinBound, tMaxBound;
		...
		{
			Array.Resize<Vector2>(ref tPoints, tPoints.Length * 2);
